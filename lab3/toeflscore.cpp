...
{
    // set the total score to be the sum of the individual paramters
    // since totalScore isn't actually stored in the ToeflScore object,
    // it must be computed manually each time
    int total = 0;
    total += this->reading;
